                ...
                <div class="modal-body">
                    <form action="">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Tyler" class="form-control" id="player-name">
                        </div>
                        <div class="form-group">
                            <label for="player-height" class="col-form-label">Altura(M): </label>
                            <input type="text" placeholder="1.96" class="form-control" id="player-height">
                        </div>
                        <div class="form-group">
                            <label for="player-number" class="col-form-label">Numero: </label>
                            <input type="number" placeholder="14" class="form-control" id="player-number">
                        </div>
                    </form>
                </div>
